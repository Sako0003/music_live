            ...
            return Padding(
              ...
              child: ColorFiltered(
                ...
                child: Stack(children: [
                  ...
                  Positioned(bottom: 19,left: 10,
                    child: Text('Sport Music',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: size.width * 0.05),)),
                  Positioned(right: size.width * 0.01,
